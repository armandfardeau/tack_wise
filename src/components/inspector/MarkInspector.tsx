            ...
            <div className="editor-form">
              ...
              {!!mark.showRotationArrow && (
                <div className="form-row">
                  ...
                  <button id="mark-rotation-direction" type="button" className="direction-btn" aria-label={`Reverse direction (${rotationDirection === 'clockwise' ? 'Clockwise' : 'Counterclockwise'})`} onClick={() => updateMark(mark.id, { rotationDirection: rotationDirection === 'clockwise' ? 'counterclockwise' : 'clockwise' })}>
