...
export function PlaybackInspector({ isPlaying, onSetPlaySpeed, onTogglePlaying, playSpeed }: PlaybackInspectorProps) {
  return (
    <div className="editor-form">
      ...
      <button type="button" className="direction-btn" aria-label={isPlaying ? 'Pause playback' : 'Play scenario'} title={isPlaying ? 'Pause playback' : 'Play scenario'} onClick={onTogglePlaying}>
